...
FOOTER_HTML = '''
    <footer class="sd-footer">
        ...
        <div class="sd-credits" style="margin-top: 0.25rem;">
            <a href="https://github.com/StrayDogSyn" target="_blank" rel="noopener">Eric 'Hunter' Petross</a> &amp; 
            <a href="https://github.com/miasmith81" target="_blank" rel="noopener">Mia 'Mausi' Smith‑Petross</a>
        </div>
        <div class="sd-credits" style="margin-top: 0.5rem;">
            Especially for <a href="https://codethedream.org" target="_blank" rel="noopener">Code the Dream</a> students
        </div>
