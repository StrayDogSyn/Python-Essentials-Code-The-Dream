;(function(){
  ...
  function injectFooter(){var footer=document.createElement('div');footer.className='sd-footer';footer.innerHTML=
    '<img class="sd-corner left" src="'+pathToAssets()+'/brands/stray-gear.png" alt="StrayDog logo left">'
    +'<img class="sd-corner right" src="'+pathToAssets()+'/brands/stray-gear.png" alt="StrayDog logo right">'
    +'<div style="text-align:center">Created with care by <a href="https://www.straydog-syndications-llc.com/" target="_blank" rel="noopener">StrayDog</a></div>'
  ...
  function addBadge(){var header=document.querySelector('header');if(!header)return;var badge=document.createElement('span');badge.className='sd-supported-badge';badge.innerHTML='<img src="'+pathToAssets()+'/brands/stray-gear.png" alt="StrayDog badge">Supported by StrayDog';header.appendChild(badge)}
  ...
  function init(){setFavicon();addBadge();applyWatermarkIfEligible();injectFooter();abMetricsInit()}
